...
type SocialPlatform = 'instagram' | 'linkedin' | 'youtube' | 'facebook';
...
const contactInfo = {
  ...
  socialMedia: {
    ...
    youtube:  "https://youtube.com/@tcaiitbombay?si=yMLomJx4k6e3ZjgL",
              ...
              >
                ...
                <div className="mt-12">
                  ...
                  <div className="space-y-4">
                    <motion.a
                      href="https://chat.whatsapp.com/HifZhVp6c4a9GWCxMO20zY"
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <motion.a
                      href="https://forms.gle/8KhZamR2QWYRJHfT7"
                      target="_blank"
                      rel="noopener noreferrer"
